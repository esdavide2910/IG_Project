...
Escena::Escena()
{
   ...
   col_fuentes = new Col3Fuentes(); // Para proyecto GameCube
   ...
   camaras.push_back( new Camara3Modos( true, {6.0, 6.0, 6.0}, 16.0/9.0, {0.0, 0.0, 0.0}, 70.0) );
   camaras.push_back( new Camara3Modos( true, {6.0, 0.0, 0.0}, 16.0/9.0, {0.0, 0.0, 0.0}, 70.0) );
   camaras.push_back( new Camara3Modos( true, {0.001, 6.0, 0.0}, 16.0/9.0, {0.0, 0.0, 0.0}, 70.0) );
   camaras.push_back( new Camara3Modos( true, {0.0, 0.0, 6.0}, 16.0/9.0, {0.0, 0.0, 0.0}, 70.0) );
   
   camaras.push_back( new Camara3Modos( false, {6.0, 6.0, 6.0}, 16.0/9.0, {0.0, 0.0, 0.0}, 70.0) );
   camaras.push_back( new Camara3Modos( false, {6.0, 0.0, 0.0}, 16.0/9.0, {0.0, 0.0, 0.0}, 70.0) );
   camaras.push_back( new Camara3Modos( false, {0.001, 6.0, 0.0}, 16.0/9.0, {0.0, 0.0, 0.0}, 70.0) );
   camaras.push_back( new Camara3Modos( false, {0.0, 0.0, 6.0}, 16.0/9.0, {0.0, 0.0, 0.0}, 70.0) );
...
Escena1::Escena1()
{
   ...
   // .........
   objetos.push_back( new Cubo() );
   objetos.push_back( new CasaX(Tupla3f(0.5, 0.5, 0.4), Tupla3f(0.5, 0.5, 0.4)) );
   objetos.push_back( new CuadradoProfundidad() );
   objetos.push_back( new CuadradoEsquinasRedondas() );
   objetos.push_back( new CuboColores() );
   objetos.push_back( new Tetraedro() );
   objetos.push_back( new EstrellaZProfundidad(5, 0.5, 0.25, 0.15, Tupla3f(0.5, 0.5, 0)) );
   objetos.push_back( new CuboPuntas() );
...
Escena2::Escena2()
{
   ...
   objetos.push_back( new SemiCilindroBarrido(10, 15) );
   objetos.push_back( new Cilindro(1, 10) ); //El primer argumento no importa
   objetos.push_back( new Cono(1, 10) ); //El primer argumento no importa
   objetos.push_back( new Esfera(15, 15) );
   objetos.push_back( new EstrellaZProfundidad(5, 1.0, 0.5, 0.30 ) );
   objetos.push_back( new RejillaY(10,12) );
...
Escena4::Escena4()
{
   ...
   objetos.push_back( new NodoEsferaP4() );
...
Escena5::Escena5()
{
   ...
   objetos.push_back( new GameCube() );
   objetos.push_back( new GameCube("Rubik") );
